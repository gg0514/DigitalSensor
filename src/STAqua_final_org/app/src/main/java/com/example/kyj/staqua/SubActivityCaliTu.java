...
public class SubActivityCaliTu extends AppCompatActivity implements ActionBar.TabListener {

    AppSectionsPagerAdapter mAppSectionsPagerAdapter;

    static String m_strZero = "";
    static String m_str1PSample = "";
    static String m_strFilter = "";
    static String m_strTempElec = "";
    static String m_strCaliHist = "";
    static String m_strVeri = "";

    //ViewPager에는 한번에 하나의 섹션만 보여진다.
    static ViewPager mViewPager;
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sub_activity_cali_tu);
        super.getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        m_strZero = getResources().getString(R.string.multi_zero);
        ...
        m_strVeri = getResources().getString(R.string.multi_verification);
        ...
        //ViewPager를 정의하고
        mViewPager = (ViewPager) findViewById(R.id.sub_activity_cali_tu);
     ...
     //   SendProtocol((byte)0x12, 1, "0", m_strMode);
        FileLogWriter(getString(R.string.multi_cal_tu),"Start Activity");
    }
    @Override
    public void onStop() {
     ...
     //   SendProtocol((byte)0x11, 1, "0", m_strMode);
        FileLogWriter(getString(R.string.multi_cal_tu),"Stop Activity");
        super.onStop();
    }
    ...
    public static class AppSectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int pos) {
            ...
            //프래그먼트의 인스턴스를 생성한다.
            switch(pos) {
                case 0: return SubActivityCaliTuZero.newInstance("Zero, Instance 1");
                case 1: return SubActivityCaliTu1PointSample.newInstance("1Point Sample, Instance 1");
                case 2: return SubActivityCaliTuFilter.newInstance("Filter, Instance 1");
                case 3: return SubActivityCaliTuTemperatureElectrode.newInstance("Temperature Electrode, Instance 1");
                case 4: return SubActivityCaliTuCalibrationHistory.newInstance("Calibration History, Instance 1");
                case 5: return SubActivityCaliTuVerification.newInstance("Verification, Instance 1");
                default: return SubActivityCaliTuZero.newInstance("Zero, Default");
            }
        }
        ...
        public CharSequence getPageTitle(int position) {
            //프래그먼트의 인스턴스를 생성한다.
            switch(position) {
                case 0: return m_strZero;
                case 1: return m_str1PSample;
                case 2: return m_strFilter;
                case 3: return m_strTempElec;
                case 4: return m_strCaliHist;
                case 5: return m_strVeri;
                default: return "";
            }
//
