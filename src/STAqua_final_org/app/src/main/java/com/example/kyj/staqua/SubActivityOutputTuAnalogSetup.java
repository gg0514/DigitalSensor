...
public class SubActivityOutputTuAnalogSetup extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.sub_activity_output_tu_analogsetup, container, false);

        edRange4mAChange = (EditText)v.findViewById(R.id.Output_Tu_AS_RangeSetting_4ma_Ed_Change);
        edRange4mACurrent = (EditText)v.findViewById(R.id.Output_Tu_AS_RangeSetting_4ma_Ed_Current);
        edRange20mAChange = (EditText)v.findViewById(R.id.Output_Tu_AS_RangeSetting_20ma_Ed_Change);
        edRange20mACurrent = (EditText)v.findViewById(R.id.Output_Tu_AS_RangeSetting_20ma_Ed_Current);
        edAnalog4mAChange = (EditText)v.findViewById(R.id.Output_Tu_AS_AnalogOutput_4ma_Ed_Change);
        edAnalog4mACurrent = (EditText)v.findViewById(R.id.Output_Tu_AS_AnalogOutput_4ma_Ed_Current);
        edAnalog20mAChange = (EditText)v.findViewById(R.id.Output_Tu_AS_AnalogOutput_20ma_Ed_Change);
        edAnalog20mACurrent = (EditText)v.findViewById(R.id.Output_Tu_AS_AnalogOutput_20ma_Ed_Current);
        ...
        v.findViewById(R.id.Output_Tu_AS_Main).setOnClickListener(mvClickListener);
        v.findViewById(R.id.Output_Tu_AS_RangeSetting_4ma_Btn_Up).setOnClickListener(mClickListener);
        v.findViewById(R.id.Output_Tu_AS_RangeSetting_4ma_Btn_Down).setOnClickListener(mClickListener);
        v.findViewById(R.id.Output_Tu_AS_RangeSetting_20ma_Btn_Up).setOnClickListener(mClickListener);
        v.findViewById(R.id.Output_Tu_AS_RangeSetting_20ma_Btn_Down).setOnClickListener(mClickListener);
        v.findViewById(R.id.Output_Tu_AS_AnalogOutput_4ma_Btn_Up).setOnClickListener(mClickListener);
        v.findViewById(R.id.Output_Tu_AS_AnalogOutput_4ma_Btn_Down).setOnClickListener(mClickListener);
        v.findViewById(R.id.Output_Tu_AS_AnalogOutput_20ma_Btn_Up).setOnClickListener(mClickListener);
        v.findViewById(R.id.Output_Tu_AS_AnalogOutput_20ma_Btn_Down).setOnClickListener(mClickListener);

        v.findViewById(R.id.Output_Tu_AS_Option1_Hold).setOnClickListener(mClickListener);
        v.findViewById(R.id.Output_Tu_AS_Option2_Apply).setOnClickListener(mClickListener);
        v.findViewById(R.id.Output_Tu_AS_Option2_FactoryReset).setOnClickListener(mClickListener);


        prefs = getActivity().getSharedPreferences("Tu_Analog", MODE_PRIVATE);
    ...
    public static SubActivityOutputTuAnalogSetup newInstance(String text) {

        SubActivityOutputTuAnalogSetup f = new SubActivityOutputTuAnalogSetup();
        Bundle b = new Bundle();
    ...
    EditText.OnFocusChangeListener meClickListener  = new View.OnFocusChangeListener(){
        public void onFocusChange(View v, boolean hasFocus) {
            ...
            {
                switch(v.getId()){
                    case R.id.Output_Tu_AS_RangeSetting_4ma_Ed_Change:
                        edRange4mAChange.setText("");
                        break;
                    case R.id.Output_Tu_AS_RangeSetting_20ma_Ed_Change:
                        edRange20mAChange.setText("");
                        break;
                    case R.id.Output_Tu_AS_AnalogOutput_4ma_Ed_Change:
                        edAnalog4mAChange.setText("");
                        break;
                    case R.id.Output_Tu_AS_AnalogOutput_20ma_Ed_Change:
    ...
    Button.OnClickListener mClickListener  = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.Output_Tu_AS_RangeSetting_4ma_Btn_Up:
                    ...
                    break;
                case R.id.Output_Tu_AS_RangeSetting_4ma_Btn_Down:
                    beforeText = edRange4mAChange.getText().toString();
                    if(beforeText.length() == 0) beforeText = "0.00";
                    dbCalibration = parseDouble(beforeText);
                    dbCalibration = dbCalibration - 0.01;
                    ...
                    edRange4mAChange.setText(Double.toString(dbCalibration));
                    break;
                case R.id.Output_Tu_AS_RangeSetting_20ma_Btn_Up:
                    ...
                    break;
                case R.id.Output_Tu_AS_RangeSetting_20ma_Btn_Down:
                    beforeText = edRange20mAChange.getText().toString();
                    if(beforeText.length() == 0) beforeText = "0.00";
                    dbCalibration = parseDouble(beforeText);
                    dbCalibration = dbCalibration - 0.01;
                    ...
                    edRange20mAChange.setText(Double.toString(dbCalibration));
                    break;
                case R.id.Output_Tu_AS_AnalogOutput_4ma_Btn_Up:
                    ...
                    break;
                case R.id.Output_Tu_AS_AnalogOutput_4ma_Btn_Down:
                    beforeText = edAnalog4mAChange.getText().toString();
                    if(beforeText.length() == 0) beforeText = "0";
                    nCalibration = parseInt(beforeText);
                    nCalibration = nCalibration - 1;
                    edAnalog4mAChange.setText(Integer.toString(nCalibration));
                    break;
                case R.id.Output_Tu_AS_AnalogOutput_20ma_Btn_Up:
                    ...
                    break;
                case R.id.Output_Tu_AS_AnalogOutput_20ma_Btn_Down:
                    beforeText = edAnalog20mAChange.getText().toString();
                    if(beforeText.length() == 0) beforeText = "0";
                    nCalibration = parseInt(beforeText);
                    nCalibration = nCalibration - 1;
                    edAnalog20mAChange.setText(Integer.toString(nCalibration));
                    break;
                case R.id.Output_Tu_AS_Option2_Apply:
                    ...
                    break;
                case R.id.Output_Tu_AS_Option2_FactoryReset:
                    m_strRange4mA = "0.00";
                    m_strRange20mA = "10.00";
                    m_strAnalog4mA = "4800";
    ...
    private class AnalogTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if(s.toString().length() > 0){
                if ((et.getId() == R.id.Output_Tu_AS_RangeSetting_4ma_Ed_Change) || (et.getId() == R.id.Output_Tu_AS_RangeSetting_20ma_Ed_Change))
                {
                    if((parseDouble(s.toString()) > 14) || (parseDouble(s.toString()) < 0)){
                        et.setText(beforeText);
                        Toast.makeText(getActivity(), R.string.multi_tu_analog_validation, Toast.LENGTH_LONG).show();//토스트메세지를 띄운다.
                    }
                }
                else if ((et.getId() == R.id.Output_Tu_AS_AnalogOutput_4ma_Ed_Change) || (et.getId() == R.id.Output_Tu_AS_AnalogOutput_20ma_Ed_Change))
                {
