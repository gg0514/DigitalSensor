...
public class SubActivityCaliTu1PointSample extends Fragment {
    private static SubActivityCaliTu1PointSample.Tu1PointSampleSendThread m_Tu1PointSampleSendThread;
    private static SubActivityCaliTu1PointSample.UpdateCurrentValueThread m_UpdateCurrentValueThreadThread;
    EditText edCurrent;
    Button btApply;
    TextView tvHelpText;
    ImageView ivIcon;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.sub_activity_cali_tu_1pointsample, container, false);

        edCalibration = (EditText)v.findViewById(R.id.Cali_Tu_1PS_Calibration_Ed);
        ...
        ivIcon = (ImageView)v.findViewById(R.id.Cali_Tu_1PS_Help_Icon_Beaker);
        pgCircle = (ProgressBar)v.findViewById(R.id.Cali_Tu_1PS_Help_Progress);
        tvHelpText = (TextView)v.findViewById(R.id.Cali_Tu_1PS_Help_Text1);
        edCurrent = (EditText)v.findViewById(R.id.Cali_Tu_1PS_Current_Ed);
        btApply = (Button)v.findViewById(R.id.Cali_Tu_1PS_Option2_Apply);

        v.findViewById(R.id.Cali_Tu_1PS_Main).setOnClickListener(mClickListener);
        v.findViewById(R.id.Cali_Tu_1PS_UpDown_Up).setOnClickListener(mClickListener);
        v.findViewById(R.id.Cali_Tu_1PS_UpDown_Down).setOnClickListener(mClickListener);
        v.findViewById(R.id.Cali_Tu_1PS_Option2_Stop).setOnClickListener(mClickListener);
        v.findViewById(R.id.Cali_Tu_1PS_Option2_Apply).setOnClickListener(mClickListener);

        DecimalFormat df2Figure = new DecimalFormat("0.00");
        edCurrent.setText( df2Figure.format(m_dTu));
        edCalibration.setText( df2Figure.format(m_dTu));

        m_Tu1PointSampleSendThread = new Tu1PointSampleSendThread(true);
    ...
    @Override
    public void onStop() {
        if (m_Tu1PointSampleSendThread != null){
            m_Tu1PointSampleSendThread.stopTu1PointSampleSendThread();
        }
    ...
    public static SubActivityCaliTu1PointSample newInstance(String text) {
        SubActivityCaliTu1PointSample f = new SubActivityCaliTu1PointSample();
        Bundle b = new Bundle();
    ...
    public void startTu1PointSampleSendThread(){
        if (!m_Tu1PointSampleSendThread.isAlive()){
            m_Tu1PointSampleSendThread = new Tu1PointSampleSendThread(true);
            m_Tu1PointSampleSendThread.start();
        }
    }
    ...
    Button.OnClickListener mClickListener  = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.Cali_Tu_1PS_UpDown_Up:
                    ...
                    break;
                case R.id.Cali_Tu_1PS_UpDown_Down:
                    dbCalibration = dbCalibration - 0.01;
                    dbCalibration = Double.parseDouble(df2Figure.format(dbCalibration));
                    edCalibration.setText(Double.toString(dbCalibration));
                    break;
                case R.id.Cali_Tu_1PS_Option2_Stop :
                    m_nCaliStatus = 16;
                    FileLogWriter(getString(R.string.multi_cal_tu_1p_sample),"Click Stop");
                    break;
                case R.id.Cali_Tu_1PS_Option2_Apply:
                    ...
                    m_nCaliStatus = 1;
                    startTu1PointSampleSendThread();
                    FileLogWriter(getString(R.string.multi_cal_tu_1p_sample),"Click Apply");
    ...
    private class CalibrationTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if(s.toString().length() > 0){
                if((Double.parseDouble(s.toString()) > 20) || (Double.parseDouble(s.toString()) < 0)){
    ...
    class Tu1PointSampleSendThread extends Thread {
        private boolean isPlay = false;
        private int nCount = 0;
        public Tu1PointSampleSendThread(boolean isPlay) {this.isPlay = isPlay;}
        public void stopTu1PointSampleSendThread(){
            isPlay = !isPlay;
            nCount = 0;
