...
public class SubActivityCaliCh extends AppCompatActivity implements ActionBar.TabListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sub_activity_cali_ch);
        ...
        m_strPhComp = getResources().getString(R.string.multi_ph_compensation);
        ...
        //ViewPager를 정의하고
        mViewPager = (ViewPager) findViewById(R.id.sub_activity_cali_ch);
   ...
   //     SendProtocol((byte)0x12, 1, "0", m_strMode);
        FileLogWriter(getString(R.string.multi_cal_ch),"Start Activity");
    }
   ...
   //     SendProtocol((byte)0x11, 1, "0", m_strMode);
    ...
    public static class AppSectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int pos) {
            ...
            //프래그먼트의 인스턴스를 생성한다.
            switch(pos) {
                case 0: return SubActivityCaliChZero.newInstance("Zero, Instance 1");
                case 1: return SubActivityCaliCh1PointSample.newInstance("1Point Sample, Instance 1");
                case 2: return SubActivityCaliChFilter.newInstance("Filter, Instance 1");
                case 3: return SubActivityCaliChTemperatureElectrode.newInstance("Temperature Electrode, Instance 1");
                case 4: return SubActivityCaliChCalibrationHistory.newInstance("Calibration History, Instance 1");
                case 5: return SubActivityCaliChPhCompensation.newInstance("pH Comp., Instance 1");
                default: return SubActivityCaliChZero.newInstance("Zero, Default");
            }
        }
