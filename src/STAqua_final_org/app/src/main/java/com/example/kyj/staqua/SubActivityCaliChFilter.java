...
import static com.example.kyj.staqua.MainActivity.m_nChFilterNumber;
import static com.example.kyj.staqua.MainActivity.m_nFilterCh;

/**
 * Created by KYJ on 2017-01-16.
 */

public class SubActivityCaliChFilter extends Fragment {
    private static SubActivityCaliChFilter.UpdateCheckThread m_UpdateCheckThread;
    private EditText edCalibration;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.sub_activity_cali_ch_filter, container, false);

        edCalibration = (EditText)v.findViewById(R.id.Cali_Ch_Filter_DataFilter_Ed);
        ...
        v.findViewById(R.id.Cali_Ch_Filter_Main).setOnClickListener(mClickListener);

      //  SendProtocol((byte)0x07, 1, "4", m_strMode);
        SystemClock.sleep(200);
        edCalibration.setText(Integer.toString(m_nChFilterNumber));

        v.findViewById(R.id.Cali_Ch_Filter_Option1_Stop).setOnClickListener(mClickListener);
        v.findViewById(R.id.Cali_Ch_Filter_Option2_Apply).setOnClickListener(mClickListener);
    ...
    public static SubActivityCaliChFilter newInstance(String text) {

        SubActivityCaliChFilter f = new SubActivityCaliChFilter();
        Bundle b = new Bundle();
    ...
    Button.OnClickListener mClickListener  = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.Cali_Ch_Filter_Option1_Stop:
                    ...
                    break ;
                case R.id.Cali_Ch_Filter_Option2_Apply:
    ...
    private final Handler mHandler = new Handler() { //핸들러를 통해 UI스레드에 접근한다.
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1)
            {
                edCalibration.setText(String.valueOf(m_nFilterCh));
            }
        }
    };
}
