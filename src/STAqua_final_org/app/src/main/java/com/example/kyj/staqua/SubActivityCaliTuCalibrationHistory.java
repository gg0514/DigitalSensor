...
public class SubActivityCaliTuCalibrationHistory extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.sub_activity_cali_tu_calibrationhistory, container, false);
        adapter = new ArrayAdapter(getActivity(), R.layout.result_item) ;
        listview = (ListView) v.findViewById(R.id.Cali_Tu_Cal_List_List) ;
        v.findViewById(R.id.Cali_Tu_Cal_Option1_DeleteAll).setOnClickListener(mClickListener);
        v.findViewById(R.id.Cali_Tu_Cal_Option1_Load).setOnClickListener(mClickListener);
        return v;
    }
    public static void GetCalibtationData(){
        String dirPath = Environment.getExternalStorageDirectory()+"/STAqua/Calibration/TU_Cali.txt";
        try{
    ...
    public static SubActivityCaliTuCalibrationHistory newInstance(String text) {
        SubActivityCaliTuCalibrationHistory f = new SubActivityCaliTuCalibrationHistory();
        Bundle b = new Bundle();
    ...
    Button.OnClickListener mClickListener  = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.Cali_Tu_Cal_Option1_Load:
                    ...
                    break;
                case R.id.Cali_Tu_Cal_Option1_DeleteAll:
