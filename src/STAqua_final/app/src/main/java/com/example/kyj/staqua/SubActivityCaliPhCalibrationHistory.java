...
public class SubActivityCaliPhCalibrationHistory extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.sub_activity_cali_ph_calibrationhistory, container, false);
        adapter = new ArrayAdapter(getActivity(), R.layout.result_item) ;
        listview = (ListView) v.findViewById(R.id.Cali_Ph_Cal_List_List) ;
        v.findViewById(R.id.Cali_Ph_Cal_Option1_DeleteAll).setOnClickListener(mClickListener);
        v.findViewById(R.id.Cali_Ph_Cal_Option1_Load).setOnClickListener(mClickListener);
        //GetCalibtationData();
        return v;
    }

    public static void GetCalibtationData(){
        String dirPath = Environment.getExternalStorageDirectory()+"/STAqua/Calibration/PH_Cali.txt";
        try{
    ...
    public static SubActivityCaliPhCalibrationHistory newInstance(String text) {

        SubActivityCaliPhCalibrationHistory f = new SubActivityCaliPhCalibrationHistory();
        Bundle b = new Bundle();
    ...
    Button.OnClickListener mClickListener  = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.Cali_Ph_Cal_Option1_Load:
                    ...
                    break;
                case R.id.Cali_Ph_Cal_Option1_DeleteAll:
