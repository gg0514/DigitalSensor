...
import static com.example.kyj.staqua.MainActivity.m_nFilterTu;
import static com.example.kyj.staqua.MainActivity.m_nTuFilterNumber;

/**
 * Created by KYJ on 2017-01-16.
 */

public class SubActivityCaliTuFilter extends Fragment {
    private static SubActivityCaliTuFilter.UpdateCheckThread m_UpdateCheckThread;
    private EditText edCalibration;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.sub_activity_cali_tu_filter, container, false);

        edCalibration = (EditText)v.findViewById(R.id.Cali_Tu_Filter_DataFilter_Ed);
        ...
        v.findViewById(R.id.Cali_Tu_Filter_Main).setOnClickListener(mClickListener);

   //     SendProtocol((byte)0x07, 1, "3", m_strMode);
        SystemClock.sleep(200);
        edCalibration.setText(Integer.toString(m_nTuFilterNumber));

        v.findViewById(R.id.Cali_Tu_Filter_Option1_Stop).setOnClickListener(mClickListener);
        v.findViewById(R.id.Cali_Tu_Filter_Option2_Apply).setOnClickListener(mClickListener);
    ...
    public static SubActivityCaliTuFilter newInstance(String text) {
        SubActivityCaliTuFilter f = new SubActivityCaliTuFilter();
        Bundle b = new Bundle();
    ...
    Button.OnClickListener mClickListener  = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.Cali_Tu_Filter_Option1_Stop:
                    ...
                    break ;
                case R.id.Cali_Tu_Filter_Option2_Apply:
                    ...
                    FileLogWriter(getString(R.string.multi_cal_tu_filter),"Click Apply");
                    Toast.makeText(getActivity(), R.string.multi_applied, Toast.LENGTH_LONG).show();//토스트메세지를 띄운다.
                    break ;
            }
        }
    ...
    private final Handler mHandler = new Handler() { //핸들러를 통해 UI스레드에 접근한다.
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1)
            {
                edCalibration.setText(String.valueOf(m_nFilterTu));
            }
        }
    };
}
