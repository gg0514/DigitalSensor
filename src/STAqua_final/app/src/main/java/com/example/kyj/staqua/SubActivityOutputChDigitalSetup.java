...
import static com.example.kyj.staqua.MainActivity.m_bChPhaseIsHigh;
import static com.example.kyj.staqua.MainActivity.m_dChDeadBand;
import static com.example.kyj.staqua.MainActivity.m_dChHighAlarm;
import static com.example.kyj.staqua.MainActivity.m_dChLowAlarm;
import static android.content.Context.MODE_PRIVATE;
import static com.example.kyj.staqua.MainActivity.m_dChSetPoint;
import static com.example.kyj.staqua.MainActivity.m_nChOffDelay;
import static com.example.kyj.staqua.MainActivity.m_nChOnDelay;
...
public class SubActivityOutputChDigitalSetup extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.sub_activity_output_ch_digitalsetup, container, false);

        edHighAlarmCurrent = (EditText)v.findViewById(R.id.Output_Ch_DS_HighAlarm_Ed_Current);
        edHighAlarmChange = (EditText)v.findViewById(R.id.Output_Ch_DS_HighAlarm_Ed_Change);
        edLowAlarmCurrent = (EditText)v.findViewById(R.id.Output_Ch_DS_LowAlarm_Ed_Current);
        edLowAlarmChange = (EditText)v.findViewById(R.id.Output_Ch_DS_LowAlarm_Ed_Change);
        edRelaySelectionCurrent = (EditText)v.findViewById(R.id.Output_Ch_DS_RelaySelection_Ed_Current);
        edPhaseCurrent = (EditText)v.findViewById(R.id.Output_Ch_DS_Phase_Ed_Current);
        edDeadBandCurrent = (EditText)v.findViewById(R.id.Output_Ch_DS_Deadband_Ed_Current);
        edDeadBandChange = (EditText)v.findViewById(R.id.Output_Ch_DS_Deadband_Ed_Change);
        edOnDelayCurrent = (EditText)v.findViewById(R.id.Output_Ch_DS_OnDelay_Ed_Current);
        edOnDelayChange = (EditText)v.findViewById(R.id.Output_Ch_DS_OnDelay_Ed_Change);
        edOffDelayCurrent = (EditText)v.findViewById(R.id.Output_Ch_DS_OffDelay_Ed_Current);
        edOffDelayChange = (EditText)v.findViewById(R.id.Output_Ch_DS_OffDelay_Ed_Change);
        edSetPointCurrent = (EditText)v.findViewById(R.id.Output_Ch_DS_Setpoint_Ed_Current);
        edSetPointChange = (EditText)v.findViewById(R.id.Output_Ch_DS_Setpoint_Ed_Change);
        edRelayCurrent = (EditText)v.findViewById(R.id.Output_Ch_DS_Relay_Ed_Current);
        ...
        spRelaySelection = (Spinner) v.findViewById(R.id.Output_Ch_DS_RelaySelection_Sp_Change);
        ...
        spPhase = (Spinner) v.findViewById(R.id.Output_Ch_DS_Phase_Sp_Change);
        ...
        spRelay = (Spinner) v.findViewById(R.id.Output_Ch_DS_Relay_Sp_Change);
        ...
        v.findViewById(R.id.Output_Ch_DS_Main).setOnClickListener(mvClickListener);
        v.findViewById(R.id.Output_Ch_DS_Option1_Apply).setOnClickListener(mClickListener);
        v.findViewById(R.id.Output_Ch_DS_Option1_FactoryReset).setOnClickListener(mClickListener);

        prefs = getActivity().getSharedPreferences("Ch_Digital", MODE_PRIVATE);
        edHighAlarmCurrent.setText(Double.toString(m_dChHighAlarm));
        edHighAlarmChange.setText(Double.toString(m_dChHighAlarm));
        edLowAlarmCurrent.setText(Double.toString(m_dChLowAlarm));
        edLowAlarmChange.setText(Double.toString(m_dChLowAlarm));
        if (m_bChPhaseIsHigh) spPhase.setSelection(0);
        else spPhase.setSelection(1);
        edDeadBandCurrent.setText(Double.toString(m_dChDeadBand));
        edDeadBandChange.setText(Double.toString(m_dChDeadBand));
        edOnDelayCurrent.setText(Integer.toString(m_nChOnDelay));
        edOnDelayChange.setText(Integer.toString(m_nChOnDelay));
        edOffDelayCurrent.setText(Integer.toString(m_nChOffDelay));
        edOffDelayChange.setText(Integer.toString(m_nChOffDelay));
        edSetPointCurrent.setText(Double.toString(m_dChSetPoint));
        edSetPointChange.setText(Double.toString(m_dChSetPoint));
        return v;
    }

    public static SubActivityOutputChDigitalSetup newInstance(String text) {

        SubActivityOutputChDigitalSetup f = new SubActivityOutputChDigitalSetup();
        Bundle b = new Bundle();
    ...
    private class DigitalTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if(s.toString().length() > 0){
                if ((et.getId() == R.id.Output_Ch_DS_HighAlarm_Ed_Change) || (et.getId() == R.id.Output_Ch_DS_LowAlarm_Ed_Change) || (et.getId() == R.id.Output_Ch_DS_Deadband_Ed_Change)|| (et.getId() == R.id.Output_Ch_DS_Setpoint_Ed_Change))
                {
                ...
                else if ((et.getId() == R.id.Output_Ch_DS_OnDelay_Ed_Change) || (et.getId() == R.id.Output_Ch_DS_OffDelay_Ed_Change))
                {
...
//            tv.setHeight(50);
    ...
    EditText.OnFocusChangeListener meClickListener  = new View.OnFocusChangeListener(){
        public void onFocusChange(View v, boolean hasFocus) {
            ...
            {
                switch(v.getId()){
                    case R.id.Output_Ch_DS_HighAlarm_Ed_Change:
                        edHighAlarmChange.setText("");
                        break;
                    case R.id.Output_Ch_DS_LowAlarm_Ed_Change:
                        edLowAlarmChange.setText("");
                        break;
                    case R.id.Output_Ch_DS_Deadband_Ed_Change:
                        edDeadBandChange.setText("");
                        break;
                    case R.id.Output_Ch_DS_OnDelay_Ed_Change:
                        edOnDelayChange.setText("");
                        break;
                    case R.id.Output_Ch_DS_OffDelay_Ed_Change:
                        edOffDelayChange.setText("");
                        break;
                    case R.id.Output_Ch_DS_Setpoint_Ed_Change:
    ...
    Button.OnClickListener mClickListener  = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.Output_Ch_DS_Option1_Apply:
                    ...
                    // Main 에 알람 상하값 저장
                    m_dChHighAlarm = Double.parseDouble(edHighAlarmChange.getText().toString());
                    m_dChLowAlarm = Double.parseDouble(edLowAlarmChange.getText().toString());
                    if (spPhase.getSelectedItem().toString().equals("High")) m_bChPhaseIsHigh = TRUE;
                    else if  (spPhase.getSelectedItem().toString().equals("Low")) m_bChPhaseIsHigh = FALSE;
                    m_dChDeadBand = Double.parseDouble(edDeadBandChange.getText().toString());
                    m_nChOnDelay = Integer.parseInt(edOnDelayChange.getText().toString());
                    m_nChOffDelay = Integer.parseInt(edOffDelayChange.getText().toString());
                    m_dChSetPoint = Double.parseDouble(edSetPointChange.getText().toString());
                    ...
                    break;
                case R.id.Output_Ch_DS_Option1_FactoryReset:
                    String strHighAlarm = "2.0";
