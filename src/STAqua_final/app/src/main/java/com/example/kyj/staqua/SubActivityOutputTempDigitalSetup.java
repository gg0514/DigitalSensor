...
import static com.example.kyj.staqua.MainActivity.m_bTempPhaseIsHigh;
import static com.example.kyj.staqua.MainActivity.m_dTempDeadBand;
import static com.example.kyj.staqua.MainActivity.m_dTempHighAlarm;
import static com.example.kyj.staqua.MainActivity.m_dTempLowAlarm;
import static android.content.Context.MODE_PRIVATE;
import static com.example.kyj.staqua.MainActivity.m_dTempSetPoint;
import static com.example.kyj.staqua.MainActivity.m_nTempOffDelay;
import static com.example.kyj.staqua.MainActivity.m_nTempOnDelay;
...
public class SubActivityOutputTempDigitalSetup extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.sub_activity_output_temp_digitalsetup, container, false);

        edHighAlarmCurrent = (EditText)v.findViewById(R.id.Output_Temp_DS_HighAlarm_Ed_Current);
        edHighAlarmChange = (EditText)v.findViewById(R.id.Output_Temp_DS_HighAlarm_Ed_Change);
        edLowAlarmCurrent = (EditText)v.findViewById(R.id.Output_Temp_DS_LowAlarm_Ed_Current);
        edLowAlarmChange = (EditText)v.findViewById(R.id.Output_Temp_DS_LowAlarm_Ed_Change);
        edRelaySelectionCurrent = (EditText)v.findViewById(R.id.Output_Temp_DS_RelaySelection_Ed_Current);
        edPhaseCurrent = (EditText)v.findViewById(R.id.Output_Temp_DS_Phase_Ed_Current);
        edDeadBandCurrent = (EditText)v.findViewById(R.id.Output_Temp_DS_Deadband_Ed_Current);
        edDeadBandChange = (EditText)v.findViewById(R.id.Output_Temp_DS_Deadband_Ed_Change);
        edOnDelayCurrent = (EditText)v.findViewById(R.id.Output_Temp_DS_OnDelay_Ed_Current);
        edOnDelayChange = (EditText)v.findViewById(R.id.Output_Temp_DS_OnDelay_Ed_Change);
        edOffDelayCurrent = (EditText)v.findViewById(R.id.Output_Temp_DS_OffDelay_Ed_Current);
        edOffDelayChange = (EditText)v.findViewById(R.id.Output_Temp_DS_OffDelay_Ed_Change);
        edSetPointCurrent = (EditText)v.findViewById(R.id.Output_Temp_DS_Setpoint_Ed_Current);
        edSetPointChange = (EditText)v.findViewById(R.id.Output_Temp_DS_Setpoint_Ed_Change);
        edRelayCurrent = (EditText)v.findViewById(R.id.Output_Temp_DS_Relay_Ed_Current);
        ...
        spRelaySelection = (Spinner) v.findViewById(R.id.Output_Temp_DS_RelaySelection_Sp_Change);
        ...
        spPhase = (Spinner) v.findViewById(R.id.Output_Temp_DS_Phase_Sp_Change);
        ...
        spRelay = (Spinner) v.findViewById(R.id.Output_Temp_DS_Relay_Sp_Change);
        ...
        v.findViewById(R.id.Output_Temp_DS_Main).setOnClickListener(mvClickListener);
        v.findViewById(R.id.Output_Temp_DS_Option1_Apply).setOnClickListener(mClickListener);
        v.findViewById(R.id.Output_Temp_DS_Option1_FactoryReset).setOnClickListener(mClickListener);

        prefs = getActivity().getSharedPreferences("Temp_Digital", MODE_PRIVATE);
        edHighAlarmCurrent.setText(Double.toString(m_dTempHighAlarm));
        edHighAlarmChange.setText(Double.toString(m_dTempHighAlarm));
        edLowAlarmCurrent.setText(Double.toString(m_dTempLowAlarm));
        edLowAlarmChange.setText(Double.toString(m_dTempLowAlarm));
        if (m_bTempPhaseIsHigh) spPhase.setSelection(0);
        else spPhase.setSelection(1);
        edDeadBandCurrent.setText(Double.toString(m_dTempDeadBand));
        edDeadBandChange.setText(Double.toString(m_dTempDeadBand));
        edOnDelayCurrent.setText(Integer.toString(m_nTempOnDelay));
        edOnDelayChange.setText(Integer.toString(m_nTempOnDelay));
        edOffDelayCurrent.setText(Integer.toString(m_nTempOffDelay));
        edOffDelayChange.setText(Integer.toString(m_nTempOffDelay));
        edSetPointCurrent.setText(Double.toString(m_dTempSetPoint));
        edSetPointChange.setText(Double.toString(m_dTempSetPoint));
        return v;
    }

    public static SubActivityOutputTempDigitalSetup newInstance(String text) {

        SubActivityOutputTempDigitalSetup f = new SubActivityOutputTempDigitalSetup();
        Bundle b = new Bundle();
    ...
    private class DigitalTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if(s.toString().length() > 0){
                if ((et.getId() == R.id.Output_Temp_DS_HighAlarm_Ed_Change) || (et.getId() == R.id.Output_Temp_DS_LowAlarm_Ed_Change) || (et.getId() == R.id.Output_Temp_DS_Deadband_Ed_Change)|| (et.getId() == R.id.Output_Temp_DS_Setpoint_Ed_Change))
                {
                    if((parseDouble(s.toString()) > 90) || (parseDouble(s.toString()) < -20)){
                        et.setText(beforeText);
                        Toast.makeText(getActivity(), R.string.multi_temp_validation, Toast.LENGTH_LONG).show();//토스트메세지를 띄운다.
                    }
                }
                else if ((et.getId() == R.id.Output_Temp_DS_OnDelay_Ed_Change) || (et.getId() == R.id.Output_Temp_DS_OffDelay_Ed_Change))
                {
...
//            tv.setHeight(50);
    ...
    EditText.OnFocusChangeListener meClickListener  = new View.OnFocusChangeListener(){
        public void onFocusChange(View v, boolean hasFocus) {
            ...
            {
                switch(v.getId()){
                    case R.id.Output_Temp_DS_HighAlarm_Ed_Change:
                        edHighAlarmChange.setText("");
                        break;
                    case R.id.Output_Temp_DS_LowAlarm_Ed_Change:
                        edLowAlarmChange.setText("");
                        break;
                    case R.id.Output_Temp_DS_Deadband_Ed_Change:
                        edDeadBandChange.setText("");
                        break;
                    case R.id.Output_Temp_DS_OnDelay_Ed_Change:
                        edOnDelayChange.setText("");
                        break;
                    case R.id.Output_Temp_DS_OffDelay_Ed_Change:
                        edOffDelayChange.setText("");
                        break;
                    case R.id.Output_Temp_DS_Setpoint_Ed_Change:
    ...
    Button.OnClickListener mClickListener  = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.Output_Temp_DS_Option1_Apply:
                    ...
                    // Main 에 알람 상하값 저장
                    m_dTempHighAlarm = Double.parseDouble(edHighAlarmChange.getText().toString());
                    m_dTempLowAlarm = Double.parseDouble(edLowAlarmChange.getText().toString());
                    if (spPhase.getSelectedItem().toString().equals("High")) m_bTempPhaseIsHigh = TRUE;
                    else if  (spPhase.getSelectedItem().toString().equals("Low")) m_bTempPhaseIsHigh = FALSE;
                    m_dTempDeadBand = Double.parseDouble(edDeadBandChange.getText().toString());
                    m_nTempOnDelay = Integer.parseInt(edOnDelayChange.getText().toString());
                    m_nTempOffDelay = Integer.parseInt(edOffDelayChange.getText().toString());
                    m_dTempSetPoint = Double.parseDouble(edSetPointChange.getText().toString());
                    ...
                    break;
                case R.id.Output_Temp_DS_Option1_FactoryReset:
                    String strHighAlarm = "90.00";
