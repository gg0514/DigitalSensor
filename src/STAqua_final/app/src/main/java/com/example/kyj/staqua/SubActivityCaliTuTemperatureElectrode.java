...
public class SubActivityCaliTuTemperatureElectrode extends Fragment {
    private static SubActivityCaliTuTemperatureElectrode.TuTemperatureElectrodeSendThread m_TuTemperatureElectrodeSendThread;
    private static SubActivityCaliTuTemperatureElectrode.UpdateCurrentValueThread m_UpdateCurrentValueThreadThread;
    EditText edCurrent;
    Button btApply;
    TextView tvHelpText;
    ImageView ivIcon;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.sub_activity_cali_tu_temperatureelectrode, container, false);

        ivIcon = (ImageView)v.findViewById(R.id.Cali_Tu_TE_Help_Icon_Beaker);
        pgCircle = (ProgressBar)v.findViewById(R.id.Cali_Tu_TE_Help_Progress);
        tvHelpText = (TextView)v.findViewById(R.id.Cali_Tu_TE_Help_Text1);
        edCurrent = (EditText)v.findViewById(R.id.Cali_Tu_TE_Current_Ed);
        btApply = (Button)v.findViewById(R.id.Cali_Tu_TE_Option2_Apply);

        edCalibration = (EditText)v.findViewById(R.id.Cali_Tu_TE_Calibration_Ed);
        ...
        v.findViewById(R.id.Cali_Tu_TE_Main).setOnClickListener(mClickListener);
        v.findViewById(R.id.Cali_Tu_TE_UpDown_Up).setOnClickListener(mClickListener);
        v.findViewById(R.id.Cali_Tu_TE_UpDown_Down).setOnClickListener(mClickListener);
        v.findViewById(R.id.Cali_Tu_TE_Option2_Stop).setOnClickListener(mClickListener);
        v.findViewById(R.id.Cali_Tu_TE_Option2_Apply).setOnClickListener(mClickListener);
        ...
        m_TuTemperatureElectrodeSendThread = new TuTemperatureElectrodeSendThread(true);
    ...
    @Override
    public void onStop() {
        if (m_TuTemperatureElectrodeSendThread.isAlive()){
            m_TuTemperatureElectrodeSendThread.stopTuTemperatureElectrodeSendThread();
        }
    ...
    public static SubActivityCaliTuTemperatureElectrode newInstance(String text) {
        SubActivityCaliTuTemperatureElectrode f = new SubActivityCaliTuTemperatureElectrode();
        Bundle b = new Bundle();
    ...
    public void startTuTemperatureElectrodeSendThread(){
        if (!m_TuTemperatureElectrodeSendThread.isAlive()){
            m_TuTemperatureElectrodeSendThread = new TuTemperatureElectrodeSendThread(true);
            m_TuTemperatureElectrodeSendThread.start();
        }
    }
    ...
    Button.OnClickListener mClickListener  = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            DecimalFormat df2Figure = new DecimalFormat("0.00");
            switch (v.getId()) {
                case R.id.Cali_Tu_TE_UpDown_Up:
                    ...
                    break;
                case R.id.Cali_Tu_TE_UpDown_Down:
                    dbCalibration = dbCalibration - 0.01;
                    dbCalibration = Double.parseDouble(df2Figure.format(dbCalibration));
                    edCalibration.setText(Double.toString(dbCalibration));
                    break;
                case R.id.Cali_Tu_TE_Option2_Stop :
                    m_nCaliStatus = 16;
               //     SendProtocol((byte)0x60, 1, "1", m_strMode);
                    FileLogWriter(getString(R.string.multi_cal_tu_temp_ele),"Click Stop");
                    break;
                case R.id.Cali_Tu_TE_Option2_Apply:
                 ...
                 //   String strPayload1 = edCalibration.getText().toString()+" ";
                    ...
                    m_nCaliStatus = 1;
                    startTuTemperatureElectrodeSendThread();
                    FileLogWriter(getString(R.string.multi_cal_tu_temp_ele),"Click Apply");
    ...
    class TuTemperatureElectrodeSendThread extends Thread {
        private boolean isPlay = false;
        private int nCount = 0;
        public TuTemperatureElectrodeSendThread(boolean isPlay) {this.isPlay = isPlay;}
        public void stopTuTemperatureElectrodeSendThread(){
            isPlay = !isPlay;
            nCount = 0;
        ...
        public void run() {
            ...
            while (isPlay) {
                try {
                    Thread.sleep(200);
          //          SendProtocol((byte)0x67, 1, "3", m_strMode);
                    if (m_nCaliStatus != 1)
                    {
                        stopTuTemperatureElectrodeSendThread();
                    }
                    if (nCount > 300)
                    {
                        m_nCaliStatus = 15;
