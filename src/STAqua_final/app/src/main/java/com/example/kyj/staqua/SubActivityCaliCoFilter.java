...
import static com.example.kyj.staqua.MainActivity.m_nCoFilterNumber;
import static com.example.kyj.staqua.MainActivity.m_nFilterCo;

/**
 * Created by KYJ on 2017-01-16.
 */

public class SubActivityCaliCoFilter extends Fragment {
    private static SubActivityCaliCoFilter.UpdateCheckThread m_UpdateCheckThread;
    private EditText edCalibration;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.sub_activity_cali_co_filter, container, false);

        edCalibration = (EditText)v.findViewById(R.id.Cali_Co_Filter_DataFilter_Ed);
        ...
        v.findViewById(R.id.Cali_Co_Filter_Main).setOnClickListener(mClickListener);

       // SendProtocol((byte)0x07, 1, "2", m_strMode);
        SystemClock.sleep(200);
        edCalibration.setText(Integer.toString(m_nCoFilterNumber));

        v.findViewById(R.id.Cali_Co_Filter_Option1_Stop).setOnClickListener(mClickListener);
        v.findViewById(R.id.Cali_Co_Filter_Option2_Apply).setOnClickListener(mClickListener);
    ...
    public static SubActivityCaliCoFilter newInstance(String text) {
        SubActivityCaliCoFilter f = new SubActivityCaliCoFilter();
        Bundle b = new Bundle();
    ...
    Button.OnClickListener mClickListener  = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.Cali_Co_Filter_Option1_Stop:
                    ...
                    break ;
                case R.id.Cali_Co_Filter_Option2_Apply:
                    ...
                    FileLogWriter(getString(R.string.multi_cal_co_filter),"Click Apply");
                    break ;
            }
        }
    };
    ...
    private final Handler mHandler = new Handler() { //핸들러를 통해 UI스레드에 접근한다.
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1)
            {
                edCalibration.setText(String.valueOf(m_nFilterCo));
            }
        }
    };
}
