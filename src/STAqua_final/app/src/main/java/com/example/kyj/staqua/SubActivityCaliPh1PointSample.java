...
public class SubActivityCaliPh1PointSample extends Fragment {

    private static SubActivityCaliPh1PointSample.Ph1PointSampleSendThread m_Ph1PointSampleSendThread;
    private static SubActivityCaliPh1PointSample.UpdateCurrentValueThread m_UpdateCurrentValueThreadThread;
    EditText edCurrent;
    Button btApply;
    TextView tvHelpText;
    ImageView ivIcon;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.sub_activity_cali_ph_1pointsample, container, false);

        edCalibration = (EditText)v.findViewById(R.id.Cali_Ph_1PS_Calibration_Ed);
        ...
        ivIcon = (ImageView)v.findViewById(R.id.Cali_Ph_1PS_Help_Icon_Beaker);
        pgCircle = (ProgressBar)v.findViewById(R.id.Cali_Ph_1PS_Help_Progress);
        tvHelpText = (TextView)v.findViewById(R.id.Cali_Ph_1PS_Help_Text1);
        edCurrent = (EditText)v.findViewById(R.id.Cali_Ph_1PS_Current_Ed);
        btApply = (Button)v.findViewById(R.id.Cali_Ph_1PS_Option2_Apply);

        v.findViewById(R.id.Cali_Ph_1PS_Main).setOnClickListener(mClickListener);
        v.findViewById(R.id.Cali_Ph_1PS_UpDown_Up).setOnClickListener(mClickListener);
        v.findViewById(R.id.Cali_Ph_1PS_UpDown_Down).setOnClickListener(mClickListener);
        v.findViewById(R.id.Cali_Ph_1PS_Option2_Stop).setOnClickListener(mClickListener);
        v.findViewById(R.id.Cali_Ph_1PS_Option2_Apply).setOnClickListener(mClickListener);
        ...
        m_Ph1PointSampleSendThread = new Ph1PointSampleSendThread(true);
    ...
    @Override
    public void onStop() {
        if (m_Ph1PointSampleSendThread != null){
            m_Ph1PointSampleSendThread.stopPh1PointSampleSendThread();
        }
    ...
    public static SubActivityCaliPh1PointSample newInstance(String text) {

        SubActivityCaliPh1PointSample f = new SubActivityCaliPh1PointSample();
        Bundle b = new Bundle();
    ...
    public void startPh1PointSampleSendThread(){
        if (!m_Ph1PointSampleSendThread.isAlive()){
            m_Ph1PointSampleSendThread = new Ph1PointSampleSendThread(true);
            m_Ph1PointSampleSendThread.start();
        }
    }
    ...
    View.OnClickListener mClickListener  = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.Cali_Ph_1PS_UpDown_Up:
                    ...
                    break;
                case R.id.Cali_Ph_1PS_UpDown_Down:
                    dbCalibration = dbCalibration - 0.01;
                    dbCalibration = Double.parseDouble(df2Figure.format(dbCalibration));
                    edCalibration.setText(Double.toString(dbCalibration));
                    break;
                case R.id.Cali_Ph_1PS_Option2_Stop :
                    m_nCaliStatus = 16;
                    FileLogWriter(getString(R.string.multi_cal_ph_1p_sample),"Click Stop");
                    break;
                case R.id.Cali_Ph_1PS_Option2_Apply:
    ...
    class Ph1PointSampleSendThread extends Thread {
        private boolean isPlay = false;
        private int nCount = 0;
        public Ph1PointSampleSendThread(boolean isPlay) {this.isPlay = isPlay;}
        public void stopPh1PointSampleSendThread(){
            isPlay = !isPlay;
            nCount = 0;
