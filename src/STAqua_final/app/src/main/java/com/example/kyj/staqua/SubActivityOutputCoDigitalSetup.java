...
import static com.example.kyj.staqua.MainActivity.m_bCoPhaseIsHigh;
import static com.example.kyj.staqua.MainActivity.m_dCoDeadBand;
import static com.example.kyj.staqua.MainActivity.m_dCoHighAlarm;
import static com.example.kyj.staqua.MainActivity.m_dCoLowAlarm;
import static android.content.Context.MODE_PRIVATE;
import static com.example.kyj.staqua.MainActivity.m_dCoSetPoint;
import static com.example.kyj.staqua.MainActivity.m_nCoOffDelay;
import static com.example.kyj.staqua.MainActivity.m_nCoOnDelay;
...
public class SubActivityOutputCoDigitalSetup extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.sub_activity_output_co_digitalsetup, container, false);

        edHighAlarmCurrent = (EditText)v.findViewById(R.id.Output_Co_DS_HighAlarm_Ed_Current);
        edHighAlarmChange = (EditText)v.findViewById(R.id.Output_Co_DS_HighAlarm_Ed_Change);
        edLowAlarmCurrent = (EditText)v.findViewById(R.id.Output_Co_DS_LowAlarm_Ed_Current);
        edLowAlarmChange = (EditText)v.findViewById(R.id.Output_Co_DS_LowAlarm_Ed_Change);
        edRelaySelectionCurrent = (EditText)v.findViewById(R.id.Output_Co_DS_RelaySelection_Ed_Current);
        edPhaseCurrent = (EditText)v.findViewById(R.id.Output_Co_DS_Phase_Ed_Current);
        edDeadBandCurrent = (EditText)v.findViewById(R.id.Output_Co_DS_Deadband_Ed_Current);
        edDeadBandChange = (EditText)v.findViewById(R.id.Output_Co_DS_Deadband_Ed_Change);
        edOnDelayCurrent = (EditText)v.findViewById(R.id.Output_Co_DS_OnDelay_Ed_Current);
        edOnDelayChange = (EditText)v.findViewById(R.id.Output_Co_DS_OnDelay_Ed_Change);
        edOffDelayCurrent = (EditText)v.findViewById(R.id.Output_Co_DS_OffDelay_Ed_Current);
        edOffDelayChange = (EditText)v.findViewById(R.id.Output_Co_DS_OffDelay_Ed_Change);
        edSetPointCurrent = (EditText)v.findViewById(R.id.Output_Co_DS_Setpoint_Ed_Current);
        edSetPointChange = (EditText)v.findViewById(R.id.Output_Co_DS_Setpoint_Ed_Change);
        edRelayCurrent = (EditText)v.findViewById(R.id.Output_Co_DS_Relay_Ed_Current);
        ...
        spRelaySelection = (Spinner) v.findViewById(R.id.Output_Co_DS_RelaySelection_Sp_Change);
        ...
        spPhase = (Spinner) v.findViewById(R.id.Output_Co_DS_Phase_Sp_Change);
        ...
        spRelay = (Spinner) v.findViewById(R.id.Output_Co_DS_Relay_Sp_Change);
        ...
        v.findViewById(R.id.Output_Co_DS_Main).setOnClickListener(mvClickListener);
        v.findViewById(R.id.Output_Co_DS_Option1_Apply).setOnClickListener(mClickListener);
        v.findViewById(R.id.Output_Co_DS_Option1_FactoryReset).setOnClickListener(mClickListener);

        prefs = getActivity().getSharedPreferences("Co_Digital", MODE_PRIVATE);
        edHighAlarmCurrent.setText(Double.toString(m_dCoHighAlarm));
        edHighAlarmChange.setText(Double.toString(m_dCoHighAlarm));
        edLowAlarmCurrent.setText(Double.toString(m_dCoLowAlarm));
        edLowAlarmChange.setText(Double.toString(m_dCoLowAlarm));
        if (m_bCoPhaseIsHigh) spPhase.setSelection(0);
        else spPhase.setSelection(1);
        edDeadBandCurrent.setText(Double.toString(m_dCoDeadBand));
        edDeadBandChange.setText(Double.toString(m_dCoDeadBand));
        edOnDelayCurrent.setText(Integer.toString(m_nCoOnDelay));
        edOnDelayChange.setText(Integer.toString(m_nCoOnDelay));
        edOffDelayCurrent.setText(Integer.toString(m_nCoOffDelay));
        edOffDelayChange.setText(Integer.toString(m_nCoOffDelay));
        edSetPointCurrent.setText(Double.toString(m_dCoSetPoint));
        edSetPointChange.setText(Double.toString(m_dCoSetPoint));
        return v;
    }

    public static SubActivityOutputCoDigitalSetup newInstance(String text) {

        SubActivityOutputCoDigitalSetup f = new SubActivityOutputCoDigitalSetup();
        Bundle b = new Bundle();
    ...
    private class DigitalTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if(s.toString().length() > 0){
                if ((et.getId() == R.id.Output_Co_DS_HighAlarm_Ed_Change) || (et.getId() == R.id.Output_Co_DS_LowAlarm_Ed_Change) || (et.getId() == R.id.Output_Co_DS_Deadband_Ed_Change)|| (et.getId() == R.id.Output_Co_DS_Setpoint_Ed_Change))
                {
                    if((parseDouble(s.toString()) > 500) || (parseDouble(s.toString()) < 0)){
                        et.setText(beforeText);
                        Toast.makeText(getActivity(), R.string.multi_co_validation, Toast.LENGTH_LONG).show();//토스트메세지를 띄운다.
                    }
                }
                else if ((et.getId() == R.id.Output_Co_DS_OnDelay_Ed_Change) || (et.getId() == R.id.Output_Co_DS_OffDelay_Ed_Change))
                {
...
//            tv.setHeight(50);
    ...
    EditText.OnFocusChangeListener meClickListener  = new View.OnFocusChangeListener(){
        public void onFocusChange(View v, boolean hasFocus) {
            ...
            {
                switch(v.getId()){
                    case R.id.Output_Co_DS_HighAlarm_Ed_Change:
                        edHighAlarmChange.setText("");
                        break;
                    case R.id.Output_Co_DS_LowAlarm_Ed_Change:
                        edLowAlarmChange.setText("");
                        break;
                    case R.id.Output_Co_DS_Deadband_Ed_Change:
                        edDeadBandChange.setText("");
                        break;
                    case R.id.Output_Co_DS_OnDelay_Ed_Change:
                        edOnDelayChange.setText("");
                        break;
                    case R.id.Output_Co_DS_OffDelay_Ed_Change:
                        edOffDelayChange.setText("");
                        break;
                    case R.id.Output_Co_DS_Setpoint_Ed_Change:
    ...
    Button.OnClickListener mClickListener  = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.Output_Co_DS_Option1_Apply:
                    ...
                    // Main 에 알람 상하값 저장
                    m_dCoHighAlarm = Double.parseDouble(edHighAlarmChange.getText().toString());
                    m_dCoLowAlarm = Double.parseDouble(edLowAlarmChange.getText().toString());
                    if (spPhase.getSelectedItem().toString().equals("High")) m_bCoPhaseIsHigh = TRUE;
                    else if  (spPhase.getSelectedItem().toString().equals("Low")) m_bCoPhaseIsHigh = FALSE;
                    m_dCoDeadBand = Double.parseDouble(edDeadBandChange.getText().toString());
                    m_nCoOnDelay = Integer.parseInt(edOnDelayChange.getText().toString());
                    m_nCoOffDelay = Integer.parseInt(edOffDelayChange.getText().toString());
                    m_dCoSetPoint = Double.parseDouble(edSetPointChange.getText().toString());
                    ...
                    break;
                case R.id.Output_Co_DS_Option1_FactoryReset:
                    String strHighAlarm = "500.00";
