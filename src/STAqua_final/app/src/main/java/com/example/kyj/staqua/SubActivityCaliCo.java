...
public class SubActivityCaliCo extends AppCompatActivity implements ActionBar.TabListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sub_activity_cali_co);
        ...
        //ViewPager를 정의하고
        mViewPager = (ViewPager) findViewById(R.id.sub_activity_cali_co);
   ...
   //     SendProtocol((byte)0x12, 1, "0", m_strMode);
        FileLogWriter(getString(R.string.multi_cal_co),"Start Activity");
    }
    ...
    public void onStop() {
      ...
      //  SendProtocol((byte)0x11, 1, "0", m_strMode);
        FileLogWriter(getString(R.string.multi_cal_co),"Stop Activity");
        super.onStop();
    }
    ...
    public static class AppSectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int pos) {
            ...
            //프래그먼트의 인스턴스를 생성한다.
            switch(pos) {
                case 0: return SubActivityCaliCoZero.newInstance("Zero, Instance 1");
                case 1: return SubActivityCaliCo1PointSample.newInstance("1Point Sample, Instance 1");
                case 2: return SubActivityCaliCoFilter.newInstance("Filter, Instance 1");
                case 3: return SubActivityCaliCoTemperatureElectrode.newInstance("Temperature Electrode, Instance 1");
                case 4: return SubActivityCaliCoCalibrationHistory.newInstance("Calibration History, Instance 1");
                default: return SubActivityCaliCoZero.newInstance("Zero, Default");
            }
        }
